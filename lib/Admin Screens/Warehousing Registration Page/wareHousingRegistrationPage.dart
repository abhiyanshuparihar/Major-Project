...
class WarehousingRegistrationPage extends StatefulWidget {
  @override
  _WarehousingRegistrationPageState createState() =>
      _WarehousingRegistrationPageState();
}

class _WarehousingRegistrationPageState
    extends State<WarehousingRegistrationPage> with TickerProviderStateMixin {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                success
                    ? 'Warehouse has been added to the system.'
        ...
        child: Column(
          ...
          children: [
            ...
            _buildField(
              ...
              validator: (v) =>
              v!.trim().isEmpty ? 'Enter warehouse name' : null,
            ),
            SizedBox(height: _hs(context, 16)),
  ...
  Widget _buildRegisterButton(BuildContext context) {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(_ws(context, 14)),
          onTap: _isLoading ? null : _registerWarehouse,
          child: Center(
            child: _isLoading
                ? SizedBox(
