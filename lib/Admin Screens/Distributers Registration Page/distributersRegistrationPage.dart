...
class DistributersRegistrationPage extends StatefulWidget {
  @override
  _DistributersRegistrationPageState createState() =>
      _DistributersRegistrationPageState();
}

class _DistributersRegistrationPageState
    extends State<DistributersRegistrationPage> with TickerProviderStateMixin {
  ...
  Future<void> _registerDistributer() async {
            ...
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  color: success ? Colors.green.shade500 : Colors.red.shade400,
                  size: _ws(context, 36),
                ),
              ),
              ...
              Text(
                success
                    ? 'Distributer has been added to the system.'
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  padding: EdgeInsets.symmetric(horizontal: _ws(context, 20)),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildField(
              ...
              validator: (v) =>
              v!.trim().isEmpty ? 'Enter distributer name' : null,
            ),
            SizedBox(height: _hs(context, 16)),
  ...
  Widget _buildField(
    ...
    return Column(
      ...
      children: [
        // Label
        Padding(
          padding: EdgeInsets.only(left: _ws(context, 2), bottom: _hs(context, 6)),
          child: Text(
            label.toUpperCase(),
            style: TextStyle(
  ...
  Widget _buildRegisterButton(BuildContext context) {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(_ws(context, 14)),
          onTap: _isLoading ? null : _registerDistributer,
          child: Center(
            child: _isLoading
                ? SizedBox(
