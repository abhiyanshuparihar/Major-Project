...
class ManufacturerRegisterPage extends StatefulWidget {
  @override
  _ManufacturerRegisterPageState createState() =>
      _ManufacturerRegisterPageState();
}

class _ManufacturerRegisterPageState
    extends State<ManufacturerRegisterPage> with TickerProviderStateMixin {
  ...
  Future<void> _registerManufacturer() async {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                success
                    ? 'Manufacturer has been added to the system.'
        ...
        child: Column(
          ...
          children: [
            ...
            _buildField(
              ...
              validator: (v) =>
              v!.trim().isEmpty ? 'Enter manufacturer name' : null,
            ),
            SizedBox(height: _hs(context, 16)),
  ...
  Widget _buildRegisterButton(BuildContext context) {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(_ws(context, 14)),
          onTap: _isLoading ? null : _registerManufacturer,
          child: Center(
            child: _isLoading
                ? SizedBox(
